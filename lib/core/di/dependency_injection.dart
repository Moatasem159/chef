...
Future<void> setupGetIt() async {
 ...
 getIt.registerLazySingleton<NetworkInfo>(() =>  NetworkInfo(InternetConnectionChecker()));
 getIt.registerLazySingleton<RecipeRepository>(() => RecipeRepository(getIt(),getIt()));
}
